...
<head>
  ...
  <style>
    ...
    .announcement-details { background:#f8fafc; border-radius:8px; padding:20px; margin:16px 0; }
...
<body class="email-bg" style="background:#f3f6fa;">
  ...
  <div style="display:none; font-size:1px; line-height:1px; max-height:0; max-width:0; opacity:0; overflow:hidden;">
    New announcement from ITFT: {{title}} on {{date}}. Read more inside!
  </div>
              ...
              <table role="presentation" width="100%" class="card">
                ...
                <tr>
                  <td class="header-brand center">
                    <img class="logo" src="https://drive.google.com/uc?export=view&id=1UCmgYe_iqhYGnQjjGyoMzdOzVpT7_pGj" alt="ITFT Logo" width="150">
                    <div class="spacer-16"></div>
                    <p style="color:#ffffff; font-family:'Segoe UI', Arial, Helvetica, sans-serif; font-size:14px; font-weight:600; margin:0; letter-spacing:0.5px;">LATEST ANNOUNCEMENT</p>
                  </td>
                </tr>
                  ...
                  <td class="p-24" style="padding:32px 24px 24px;">
                    ...
                    <div class="announcement-details">
                      <table role="presentation" width="100%">
                        <tr>
                          <td class="detail-item" style="vertical-align:top; text-align:center; padding:0 8px;">
                            <div class="detail-icon">📢</div>
                            <div class="detail-label text">Expiry Date</div>
                    ...
                    <p class="muted center" style="line-height:22px;">
                      You're receiving this because you subscribed to ITFT announcements.
                      <br>
